...
{
#ifdef RW_PSP
	pspTraceBoot("I10 Engine::init entro");
#endif
...
#ifdef RW_PSP
	pspTraceBoot("I11 tabla de memoria instalada");
#endif

	PluginList::open();

#ifdef RW_PSP
	pspTraceBoot("I12 lista global de plugins abierta");
#endif
...
#ifdef RW_PSP
	pspTraceBoot("I13 listas de drivers creadas");
#endif
...
#ifdef RW_PSP
	pspTraceBoot("I14 Frame registrado");
#endif
	Image::registerModule();

#ifdef RW_PSP
	pspTraceBoot("I15 Image registrado");
#endif
	Raster::registerModule();

#ifdef RW_PSP
	pspTraceBoot("I16 Raster registrado");
#endif
	Texture::registerModule();

#ifdef RW_PSP
	pspTraceBoot("I17 Texture registrado");
#endif
	...
	pspTraceBoot("I18 plugins PSP registrados");
	#elif !defined(RW_DC)
...
#ifdef RW_PSP
	pspTraceBoot("I19 Engine::init completo");
#endif
	return 1;
}
